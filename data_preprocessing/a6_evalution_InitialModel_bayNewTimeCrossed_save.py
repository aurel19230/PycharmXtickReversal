...
def train_and_evaluate_XGBOOST_model(
    ...
    ax2.set_title('Distribution des probabilités prédites sur XTest', fontsize=14, fontweight='bold')
    ...
    plt.savefig('roc_and_distribution_combined.png', dpi=300, bbox_inches='tight')
    plt.show()
    plt.close()
